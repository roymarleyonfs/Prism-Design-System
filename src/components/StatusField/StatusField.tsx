...
// Figma node: 2052-28955
export interface StatusFieldProps extends InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  helperText?: string;
  errorText?: string;
...
const StatusField = forwardRef<HTMLInputElement, StatusFieldProps>(
  (
    {
      className,
      label,
    ...
    return (
      <div className={className || 'flex flex-col gap-[var(--8px,8px)] items-start w-full'} data-node-id="2052-28955">
        {label && (
