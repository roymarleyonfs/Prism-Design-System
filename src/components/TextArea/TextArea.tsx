...
const TextArea = forwardRef<HTMLTextAreaElement, TextAreaProps>(
  (
    ...
    return (
      <div className={className || 'flex flex-col gap-[var(--8px,8px)] items-start w-full'} data-node-id="3418-426957">
        {label && (
          <div className="flex gap-[var(--0px,0px)] w-full items-start">
            ...
            {showCount && (
              <p className="font-[var(--Weight-Regular,450)] text-[length:var(--Text-Body-sm-Size,13px)] leading-[var(--Text-Body-sm-LineHeight,16px)] text-[color:var(--primitives-neutral-gray-800,#6a6b6d)] whitespace-nowrap shrink-0">
                {characterCount}
              </p>
            )}
            {showAction && (
              <div className="flex gap-[var(--4px,4px)] items-center shrink-0">
