...
// Figma node: 2049-7519
export interface PhoneNumberFieldProps extends InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  helperText?: string;
  errorText?: string;
...
const PhoneNumberField = forwardRef<HTMLInputElement, PhoneNumberFieldProps>(
  (
    ...
    return (
      <div className={className || 'flex flex-col gap-[var(--8px,8px)] items-start w-full'} data-node-id="2049-7519">
        {label && (
