...
// Figma node: 2049-17339
export interface SuffixFieldProps extends InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  helperText?: string;
  errorText?: string;
...
const SuffixField = forwardRef<HTMLInputElement, SuffixFieldProps>(
  (
    {
      className,
      label,
    ...
    return (
      <div className={className || 'flex flex-col gap-[var(--8px,8px)] items-start w-full'} data-node-id="2049-17339">
        {label && (
...
SuffixField.displayName = 'SuffixField';
